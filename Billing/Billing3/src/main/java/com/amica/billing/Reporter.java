...
public class Reporter {
	...
	public static final String CONFIG_NAME = "Reporter";
	private static final String OUTPUT_PROP = "Reporter.outputFile";
	private static final String AS_OF_PROP = "Reporter.asOfDate";
	...
	public Reporter(Configuration configuration){
		this( new Billing(configuration), configuration.getString(OUTPUT_PROP), LocalDate.parse(configuration.getString(AS_OF_PROP)) );
	}
