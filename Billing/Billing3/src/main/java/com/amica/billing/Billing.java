...
public class Billing {
	...
	private static final String CUSTOMER_PROP = "Billing.customersFile";
	private static final String INVOICE_PROP = "Billing.invoicesFile";
	...
	/**
	 * Build a Billing object based on configuration
	 */
	public Billing(Configuration configuration){
		this( configuration.getString(CUSTOMER_PROP), configuration.getString(INVOICE_PROP) );
	}

	/**
	 * Build a Billing object by getting an already initialized configuration manager
	 */
	public Billing(){
		this( ComponentConfigurationManager.getInstance().getConfiguration(CONFIG_NAME) );
	}
