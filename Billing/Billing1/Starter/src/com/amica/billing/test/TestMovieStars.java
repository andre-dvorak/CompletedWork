...
public class TestMovieStars {
	...
	public static final String CUSTOMERS_FILENAME = 
			"Starter/data/movie_Stars/customers.flat";
	public static final String INVOICES_FILENAME = 
			"Starter/data/movie_Stars/invoices.flat";
	public static final String OUTPUT_FOLDER = "Starter/reports/movie_Stars";
	...
	public static void main(String[] args) {
		...
		File workspace = new File("Starter/data/movie_Stars");
		workspace.mkdir();
		try {
			// This sets up data files just for this test, fresh copy each time,
			// and assures that the folders are in place to hold reports:
			Files.copy(Paths.get("Starter/data/customers.flat"), Paths.get(CUSTOMERS_FILENAME),
					StandardCopyOption.REPLACE_EXISTING);
			Files.copy(Paths.get("Starter/data/invoices.flat"), Paths.get(INVOICES_FILENAME),
					StandardCopyOption.REPLACE_EXISTING);
